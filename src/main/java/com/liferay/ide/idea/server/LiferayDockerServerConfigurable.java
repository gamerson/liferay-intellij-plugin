...
public class LiferayDockerServerConfigurable extends
        SettingsEditor<LiferayDockerServerConfiguration> implements LiferayWorkspaceSupport, PanelWithAnchor {

    public LiferayDockerServerConfigurable(Project project) {
    ...
    @Override
    protected void resetEditorFrom(@NotNull LiferayDockerServerConfiguration s) {

    }

    @Override
    protected void applyEditorTo(@NotNull LiferayDockerServerConfiguration s) throws ConfigurationException {
