 ...
 * @author Simon Jiang
 */
public class LiferaySpringMvcPortletWizardStep extends ModuleWizardStep implements LiferayWorkspaceSupport {

	public LiferaySpringMvcPortletWizardStep(WizardContext wizardContext, LiferaySpringMvcPortletBuilder builder) {
		_builder = builder;
	...
	private LiferaySpringMvcPortletBuilder _builder;
