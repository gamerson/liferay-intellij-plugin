 ...
 * @author Terry Jia
 */
public class LiferayModuleSpringMvcWizardStep extends ModuleWizardStep {

	public LiferayModuleSpringMvcWizardStep(WizardContext wizardContext, LiferayModuleSpringMvcBuilder builder) {
		_builder = builder;

		String liferayVersion = LiferayWorkspaceUtil.getLiferayVersion(wizardContext.getProject());
