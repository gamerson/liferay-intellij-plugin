 ...
 * @author Terry Jia
 */
public class LiferaySpringMvcPortletBuilder extends ModuleBuilder implements LiferayWorkspaceSupport {
	...
	public ModuleWizardStep getCustomOptionsStep(WizardContext context, Disposable parentDisposable) {
		return new LiferaySpringMvcPortletWizardStep(context, this);
	}
